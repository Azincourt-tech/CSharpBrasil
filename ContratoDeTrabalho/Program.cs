...
namespace ContratoDeTrabalho
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var contrato = new
            {
                Empresa = new { RazaoSocial = "Alura Serviços Hidraulicos Ltda.",
                CNPJ = new CNPJFormatter().Format("23782855000117"),
                Endereco = viaCEP.GetEndereco("04101300"),
                Numero = "123 fundos"

                },

                Funcionario = new {Nome = "Super Mario",
                CPF = new CPFFormatter().Format("06278453126"),
                RG = "6311299",
